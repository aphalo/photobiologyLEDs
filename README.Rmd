...
As LED specifications have tolerances, data obtained from individual LEDs are
to be considered only examples. 
...
© 2012-2026 Pedro J. Aphalo (pedro.aphalo@helsinki.fi). Released under the GPL, version 2 or greater. This software carries no warranty of any kind.
